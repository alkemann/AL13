    ...
    function testPagination() {
    	...
    	$expected = array(
    		array('ul' => array('class' => 'actions')),
    			...
    			'/li',
    			'<li',
    				array('a' => array('href' => $this->base .'posts?page=2&limit=3')),
    					'[2]',
    				'/a',
    			'/li',
    			'<li',
    				array('a' => array('href' => $this->base .'posts?page=3&limit=3')),
    					'[3]',
    				'/a',
    			'/li',
    			'<li',
    				array('a' => array('href' => $this->base .'posts?page=4&limit=3')),
    					'[4]',
    				'/a',
    			'/li',
    			'<li',
    	...
    	$expected = array(
    		array('ul' => array('class' => 'actions')),
    			'<li',
    				array('a' => array('href' => $this->base .'posts?page=1&limit=3')),
    					'First',
    				'/a',
    			'/li',
    			'<li',
